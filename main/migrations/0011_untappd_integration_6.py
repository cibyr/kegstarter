...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Suggestion.keg'
        db.delete_column(u'main_suggestion', 'keg_id')


    def backwards(self, orm):
        # Adding field 'Suggestion.keg'
        db.add_column(u'main_suggestion', 'keg',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Keg'], null=True),
                      keep_default=False)
