...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UntappdCredentials'
        db.create_table(u'main_untappdcredentials', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'main', ['UntappdCredentials'])


    def backwards(self, orm):
        # Deleting model 'UntappdCredentials'
        db.delete_table(u'main_untappdcredentials')
