...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LogoHint'
        db.create_table(u'main_logohint', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('resource', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('offset_left', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('offset_top', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('tooltip', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('use_year', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'main', ['LogoHint'])


    def backwards(self, orm):
        # Deleting model 'LogoHint'
        db.delete_table(u'main_logohint')
    ...
    models = {
        ...
        u'main.comment': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['main.Comment']"}),
        ...
        u'main.logohint': {
            'Meta': {'ordering': "['-date']", 'object_name': 'LogoHint'},
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'offset_left': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'offset_top': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'resource': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'tooltip': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256', 'blank': 'True'}),
            'use_year': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
