...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_suggestion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keg', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Keg'])),
            ('proposed_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
        ...
        db.send_create_signal(u'main', ['Suggestion'])

        # Adding field 'Keg.image'
        db.add_column(u'main_keg', 'image',
                      self.gf('django.db.models.fields.CharField')(max_length=2048, null=True),
                      keep_default=False)

        # Adding field 'Keg.rating'
        db.add_column(u'main_keg', 'rating',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Vote.suggestion'
        db.add_column(u'main_vote', 'suggestion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Suggestion'], null=True),
                      keep_default=False)

        # Adding field 'Purchase.suggestion'
        db.add_column(u'main_purchase', 'suggestion',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.Suggestion'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Suggestion'
        db.delete_table(u'main_suggestion')

        # Deleting field 'Vote.suggestion'
        db.delete_column(u'main_keg', 'image')

        # Deleting field 'Vote.suggestion'
        db.delete_column(u'main_keg', 'rating')

        # Deleting field 'Vote.suggestion'
        db.delete_column(u'main_vote', 'suggestion_id')

        # Deleting field 'Purchase.suggestion'
        db.delete_column(u'main_purchase', 'suggestion_id')
