...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_comment', (
            ...
            ('suggestion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Suggestion'])),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['main.Comment'])),
